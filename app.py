...
SYNONYM = {
    ...
    "부침가루": "밀가루", "튀김가루": "밀가루",
    "로메인": "상추", "양상추": "상추",
    "토르티야": "또띠아", "뚜르띠아": "또띠아", "또띠야": "또띠아",
    "우동": "우동면",
    "전분": "감자전분", "옥수수전분": "감자전분", "녹말": "감자전분",
    "마카로니": "스파게티", "펜네": "스파게티", "푸실리": "스파게티",
    "소바": "메밀면", "메밀국수": "메밀면",
    "콜리플라워": "브로콜리",
    "대구": "흰살생선", "동태": "흰살생선", "명태": "흰살생선",
    "생선": "흰살생선", "연어": "흰살생선", "가자미": "흰살생선",
    "홍합": "조개", "바지락": "조개", "모시조개": "조개",
    "다짐육": "다진고기", "갈은고기": "다진고기",
    "이집트콩": "병아리콩", "칙피": "병아리콩",
    "코코넛밀크": "우유", "두유": "우유",
    "굴소스": "굴소스", "쪽갈비": "돼지고기",
...
CATEGORIES = {
    "채소·과일": ["양파", "감자", "당근", "애호박", "양배추", "대파", "토마토", "오이",
              "가지", "버섯", "상추", "콩나물", "숙주", "피망", "시금치", "무",
              "브로콜리", "청경채", "셀러리", "옥수수", "아보카도", "완두콩",
              "레몬", "라임", "사과", "올리브", "비트"],
    "단백질": ["계란", "두부", "순두부", "돼지고기", "소고기", "닭고기", "다진고기",
            "새우", "오징어", "조개", "흰살생선", "참치캔", "베이컨", "햄",
            "소시지", "어묵", "멸치", "유부", "렌틸콩", "병아리콩", "콩"],
    "밥·면·빵": ["밥", "쌀", "소면", "스파게티", "쌀국수", "우동면", "메밀면", "면",
              "라자냐면", "떡", "식빵", "또띠아", "바게트", "피자도우",
              "라이스페이퍼", "밀가루", "빵가루", "감자전분"],
    "유제품·양념": ["치즈", "우유", "버터", "생크림", "요거트", "마요네즈", "김치", "김",
               "된장", "고추장", "춘장", "카레가루", "굴소스", "미역", "바질",
               "고수", "생강", "청양고추", "땅콩", "꿀", "계피", "커민", "단무지"],
}
